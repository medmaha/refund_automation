...
class TimezoneHandler:
    ...
    def parse_shopify_datetime(self, dt_str: str) -> datetime:
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    f"Failed to parse datetime string: {dt_str}",
                    extra={"error": str(e)},
                )
                raise
    ...
    def get_timezone_info(self) -> dict:
        ...
        return {
            ...
            "current_store": self.format_iso8601_with_tz(
                current_store, use_store_tz=True
            ),
...
def get_current_time_iso8601() -> str:
    ...
    return timezone_handler.format_iso8601_with_tz(
...
def get_current_time_utc_iso8601() -> str:
    ...
    return timezone_handler.format_iso8601_with_tz(
        timezone_handler.get_current_time_utc(), use_store_tz=False
    )
